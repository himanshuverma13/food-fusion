        ...
        <div className="max-w-md w-full mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {paymentMethod === "Cash" && (
              <>
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="cashName">
                    Name
                  </label>
                  <input
                  ...
                  {errors.cashName && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.cashName.message}
                    </p>
                  )}
                </div>
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="cashNumber">
                    Number
                  </label>
                  <input
                    {...register("cashNumber", {
                  ...
                  {errors.cashNumber && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.cashNumber.message}
                    </p>
                  )}
                </div>
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="cashAmount">
                    Amount
                  </label>
                  <input
                    {...register("cashAmount", {
            ...
            {paymentMethod === "UPI" && (
              <>
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="upiName">
                    Name
                  </label>
                  <input
                ...
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="upiNumber">
                    Number
                  </label>
                  <input
                    {...register("upiNumber", {
                  ...
                  {errors.upiNumber && (
                    <p className="text-red-500 text-sm mt-1">
                      {errors.upiNumber.message}
                    </p>
                  )}
                </div>
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="upiAmount">
                    Amount
                  </label>
                  <input
                    {...register("upiAmount", {
            ...
            {paymentMethod === "Card" && (
              <>
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="cardName">
                    Name
                  </label>
                  <input
                ...
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="cardExpiry">
                    Expiry Date
                  </label>
                  <input
                    {...register("cardExpiry", {
                ...
                <div className="mb-4">
                  <label className="block mb-2 font-bold" htmlFor="cardCVV">
                    CVV
                  </label>
                  <input

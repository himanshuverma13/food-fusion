    ...
    <>
      <div className=" px-3">
        ...
        <div className="flex justify-center items-center">
          <div className="circle-container grid grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-7 w-3/4 lg:mt-1 md:mt-5">
            {filteredTables?.map((items, index) => (
              ...
              >
                ...
                <div
                  className={`${
                    isTableBooked(items)
                      ? "-mt-14 mb-1 rounded-full shadow-md bg-[#eab688] h-12 w-12 flex justify-center"
                      : "hidden"
                  }`}
                >
                  <img src={Order} alt="Loading" className="h-9" />
                </div>

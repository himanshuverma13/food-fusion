      ...
      <div className="max-w-sm mx-auto bg-white border border-gray-400 rounded-lg p-6">
        ...
        <div>
          ...
          <div className="text-sm">
            <p>
              <span className="font-semibold tracking-wider">Name:</span> Ms.
              jci3rc
            </p>
            <p>
              <span className="font-semibold tracking-wider">Contact No.:</span>{" "}
              7869390996
            </p>
          </div>
          ...
          <tbody>
            ...
            {cart?.itemsInCart?.map((item) => (
              <tr className="border-b border-gray-300" key={item.id}>
                ...
                <td className="text-base font-semibold text-center">
                  {item.quantity}
                </td>
        ...
        <div className="text-sm my-2">
          <p className="flex justify-between my-2">
            ...
            <span>
              {cart?.itemsInCart?.reduce((acc, item) => acc + item.quantity, 0)}
            </span>
          </p>
          <p className="flex justify-between my-2">
            <span className="font-semibold tracking-wider">Tax:</span>{" "}
            <span>₹ 40</span>
          </p>

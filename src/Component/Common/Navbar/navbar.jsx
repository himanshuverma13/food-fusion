  ...
  return (
    <nav className="p-2 flex justify-between items-center">
      <div className="flex items-center">
        ...
        <div onClick={() => navigate('/')}  className="ml-4 cursor-pointer flex items-center justify-center">
          <img className='w-1/4 me-2' src={logoBgNo} alt="" />
      ...
      <div className="flex items-center mx-4 space-x-4">
        ...
        <img className='bg-red-700  rounded-full p-2' src={billing} alt="" />
      </div>

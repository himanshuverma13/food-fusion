      ...
      <div className="h-screen border-solid border-8 p-2 mx-3 border-[#544013]">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-5 bg-[#ede9dd] border-solid border-2 border-black rounded-2xl">
            ...
            <div>
              <ul>
                <li className="mx-2 bg-[#f6f6e9] w-32 text-[#544013] border-2 border-[#d79555] rounded-lg py-1 px-4">Total Items: {cart?.totalCount}</li>
                <li className="mx-3 text-xl text-[#544013]">Sub Total: ${cart?.totalCount * 2}</li>
                <SplitBill/>

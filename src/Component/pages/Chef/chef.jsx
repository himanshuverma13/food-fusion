...
const Chef = ({ cart, chef }) => {
  ...
  return (
    <>
      <Navbar />
      <div className="container mx-auto px-10 bg-[#f6f6e9] h-screen">
        {/* <div className="text-2xl font-bold">Chef</div> */}

        <div className="flex justify-between">
          {/* Search bar */}
          <div class="text-black flex justify-start my-2">
            <div class="overflow-hidden flex w-full border-solid border-2 border-black rounded-3xl bg-[#f6f6e9] my-3">
              <input
                type="text"
        ...
        <Button
          title="Order History"
          btn_class="bg-[#ede9dd] hover:bg-[#d79555] text-[#544013] text-lg py-1 px-2 border-2 border-solid border-[#544013] uppercase"
          btn_type="button"
        />
            ...
            <div className="chef-card border-solid rounded-2xl bg-white shadow-xl">
              ...
              <div className="flex items-center justify-between p-3 text-[#544013] tracking-wider font-semibold">
                ...
                <div className="font-sans text-sm">
                  <div className="text-left text-lg uppercase font-sans">
                    {item.food}
                  </div>
                  Qty - {item.quantity}
                </div>
